<template>
  <div
    v-if="data"
    class="mx-auto w-full sm:w-[70%] lg:w-[75%] max-w-7xl flex flex-col lg:flex-row gap-4 backdrop-blur-xs rounded-4xl bg-white/20 p-10 shadow-lg items-center"
  >
    <div
      class="w-full sm:w-[80%] lg:w-[30%] flex flex-col gap-4 text-center justify-center lg:mx-12 py-6 lg:py-0"
    >
    ...
    <div
      class="w-full sm:w-[90%] lg:w-[70%] grid grid-rows-2 grid-cols-3 gap-3 lg:gap-6 h-80 sm:h-100 lg:h-150"
    >
      <NuxtLink
...
<script setup lang="ts">
  ...
  const getGridClass = (index: number) => {
    ...
    const gridClasses: Record<number, string> = {
      ...
      3: 'row-span-1 col-start-1 row-start-2 sm:mb-24 mb-12',
