<template>
  <div>
    <div class="w-[90vw] md:max-w-7xl mx-auto">
    ...
    <div class="w-full h-full max-w-7xl mx-auto relative">
      <div class="mx-auto">
        ...
        <div v-else-if="tree" class="flex flex-col items-center gap-8 scroll-auto py-5">
          <div class="w-full">
            <!-- premier bloc : SOUCHE -->
            <h3 class="text-center font-heading text-2xl lg:text-3xl mb-3">La Souche</h3>
            <div class="grid grid-cols-6 gap-2 sm:gap-4 mb-15 relative">
              <CardGenealogiePage :couple="souche" />
              <div
                class="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 h-px w-2 sm:w-4 bg-primary pointer-events-none"
              />
              <div
          ...
          <div class="w-full flex flex-row justify-between gap-3 sm:gap-8">
      ...
      <div
        class="absolute flex justify-center items-center w-full left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 bg-gray-200/50 backdrop-blur-xs rounded-2xl"
      >
        <div>
          <p class="text-center text-sm lg:text-lg my-1">Après plusieurs millénaires</p>
        </div>
      </div>
    </div>
  </div>
